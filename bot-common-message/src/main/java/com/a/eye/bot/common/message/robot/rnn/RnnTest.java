...
public class RnnTest {
    ...
    private static Logger logger = LogManager.getLogger(RnnTest.class.getName());

    // define a sentence to learn
    public static final char[] LEARNSTRING = "我 住在 北京市 海淀区 西北旺 百旺茉莉园 3号楼 2单元 502.".toCharArray();

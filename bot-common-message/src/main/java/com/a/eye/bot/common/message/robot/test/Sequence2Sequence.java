...
//    public static String frPath = "D:\\Data\\training-giga-fren\\giga-fren-release2.fr";
    public static String enPath = "D:\\codes\\newstest2010.en";
    public static String frPath = "D:\\codes\\newstest2010.cn";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ComputationGraphConfiguration configuration = new NeuralNetConfiguration.Builder()
                ...
                .graphBuilder()
                .addInputs("inEn", "inFr")
                .setInputTypes(InputType.recurrent(VOCAB_SIZE), InputType.recurrent(VOCAB_SIZE))

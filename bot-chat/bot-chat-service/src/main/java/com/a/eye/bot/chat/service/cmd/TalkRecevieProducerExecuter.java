...
@Component("TalkRecevieProducer")
public class TalkRecevieProducerExecuter extends CmdProducerExecuter {

	private Logger logger = LogManager.getLogger(TalkRecevieProducerExecuter.class.getName());
	...
	public void sendMessage(JsonObject contentJson) {
		...
		this.producer(gson.toJson(content), "TalkRecevie", topicName);
	}
}

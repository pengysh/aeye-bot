package com.a.eye.bot.nlp.machine;
...
import com.a.eye.bot.nlp.machine.match.BotPropertyMatcher;
...
//				HttpClientUtil.getInstance().sendHttpGet("http://localhost:9999/wordTree?question=" + text);
		Gson gson = new Gson();
